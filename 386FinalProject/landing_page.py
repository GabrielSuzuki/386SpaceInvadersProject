...
class LandingPage:
    ...
    alien_one_imgs = [pg.transform.rotozoom(pg.image.load(f'images/GabeAlien1_{n}v2.png'), 0, 0.25) for n in range(1,3)]
    alien_two_imgs = [pg.transform.rotozoom(pg.image.load(f'images/GabeAlien4_{n}v2.png'), 0, 0.25) for n in range(1,3)]
    alien_three_imgs = [pg.transform.rotozoom(pg.image.load(f'images/GabeAlien3_{n}v2.png'), 0, 0.25) for n in range(1,3)]
    ufo_imgs = [pg.transform.rotozoom(pg.image.load(f'images/GabeAlien2_{n}v2.png'), 0, 0.7) for n in range(1,3)]
