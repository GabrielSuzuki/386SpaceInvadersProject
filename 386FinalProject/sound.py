...
class Sound:
    ...
    def play_bg(self): self.play_music('sounds/test.wav')
    def speed_up_bg1(self): self.play_music('sounds/GabeAudio2.wav')
    def speed_up_bg2(self): self.play_music('sounds/GabeAudio3.wav')
